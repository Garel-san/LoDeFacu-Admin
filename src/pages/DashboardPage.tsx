  ...
  return (
    <div className="page-stack">
      ...
      <div className="dashboard-grid">
        ...
        <div className="stat-card stat-card--system">
          ...
          <span className="stat-card__badge">Panel activo</span>
        </div>

        <div className="stat-card stat-card--db">
      ...
      <div className="quick-actions">
        <button className="quick-action" onClick={() => onNavigate("products")}>
          ...
          <div>
            <p className="quick-action__title">Gestionar productos</p>
        ...
        >
          ...
          <div>
            <p className="quick-action__title">Gestionar categorías</p>
        ...
        <button className="quick-action" onClick={() => onNavigate("zones")}>
          ...
          <div>
            <p className="quick-action__title">Zonas de delivery</p>
        ...
        <button className="quick-action" onClick={() => onNavigate("settings")}>
          ...
          <div>
            <p className="quick-action__title">Configuración del local</p>
